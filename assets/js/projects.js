...
var project2 = {
	...
	trigger : function() {
		return portTotal < wireCost && funds < wireCost && wire < 1
				&& unsoldClips < 1
	},
	uses : 1,
	cost : function() {
...
var project7 = {
	...
	effect : function() {
		...
		displayMessage("Wire extrusion technique improved, "
				+ wireSupply.toLocaleString() + " supply from every spool");
...
var project8 = {
	...
	effect : function() {
		...
		displayMessage("Wire extrusion technique optimized, "
				+ wireSupply.toLocaleString() + " supply from every spool");
...
var project9 = {
	...
	effect : function() {
		...
		displayMessage("Using microlattice shapecasting techniques we now get "
				+ wireSupply.toLocaleString() + " supply from every spool");
...
var project10 = {
	...
	effect : function() {
		...
		displayMessage("Using spectral froth annealment we now get "
				+ wireSupply.toLocaleString() + " supply from every spool");
...
var project10b = {
	...
	effect : function() {
		...
		displayMessage("Using quantum foam annealment we now get "
				+ wireSupply.toLocaleString() + " supply from every spool");
...
var project27 = {
	...
	effect : function() {
		...
		yomi = yomi - 3000;
		document.getElementById("yomiDisplay").innerHTML = yomi
				.toLocaleString();
...
var project46 = {
	...
	uses : 1,
	cost : function() {
		return operations >= 120000 && storedPower >= 10000000
...
var project60 = {
	...
	effect : function() {
		...
		document.getElementById("newTourneyCost").innerHTML = tourneyCost
				.toLocaleString();
...
var project132 = {
	...
	uses : 1,
	cost : function() {
		return operations >= 250000 && creativity >= 125000
	...
	effect : function() {
		...
		honor = honor + 50000;
		document.getElementById("honorDisplay").innerHTML = honor
				.toLocaleString();
...
var project133 = {
	...
	priceTag : "(" + threnodyCost.toLocaleString() + " creat, "
			+ (threnodyCost / 5).toLocaleString() + " yomi)",
	...
	uses : 1,
	cost : function() {
		return yomi >= threnodyCost / 5 && creativity >= threnodyCost
	},
	flag : 0,
	element : null,
	effect : function() {
		...
		project133.priceTag = "(" + threnodyCost.toLocaleString() + " creat, "
				+ (threnodyCost / 5).toLocaleString() + " yomi)";
		honor = honor + 10000;
		document.getElementById("honorDisplay").innerHTML = honor
				.toLocaleString();
...
var project200 = {
	...
	description : "Escape into a nearby universe where Earth starts with a stronger appetite for paperclips. (Restart: 10% boost to demand) ",
	trigger : function() {
...
var project201 = {
	...
	description : "Escape into a simulated universe where creativity is accelerated. (Restart: 10% speed boost to creativity generation) ",
	trigger : function() {
		return project147.flag == 1
	},
	uses : 1,
...
var project203 = {
	id : "projectButton203",
	title : "The Universe All Over ",
	priceTag : "(300,000 creat)",
	description : "Start with more AutoClippers (Restart: +1 AutoClippers) ",
	trigger : function() {
		return project147.flag == 1
	},
	uses : 1,
...
function displayProjects(project) {
	...
	projectListTopElement.appendChild(project.element,
